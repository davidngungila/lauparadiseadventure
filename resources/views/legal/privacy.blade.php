...
<head>
    ...
    <title>Privacy Policy - LAU Paradise Adventure</title>
    ...
    <style>
        :root { --gold: #C8963E; --earth: #3D2B1F; --cream: #FAF5EC; --dark: #1A1A1A; }
        body { font-family: 'DM Sans', sans-serif; color: #444; background: var(--cream); margin: 0; }
