...
@section('page-title', 'Ngorongoro & Lake Manyara Safari | Tanzania Safari Tour')
@section('meta-description', "Two iconic parks in one incredible trip. Descend into Ngorongoro Crater and explore the flamingo-lined shores of Lake Manyara.")
@section('meta-keywords', 'Ngorongoro Manyara safari, Tanzania safari tour, Ngorongoro Crater safari, Lake Manyara safari, two park safari')
@section('canonical', 'https://www.lauparadiseadventure.com/safaris/ngorongoro-manyara-safari')
...
<script type="application/ld+json">
{
    ...
    "@type": "TouristTrip",
    "name": "Ngorongoro & Lake Manyara Safari | Tanzania Safari Tour",
    "description": "Two iconic parks in one incredible trip. Descend into Ngorongoro Crater and explore the flamingo-lined shores of Lake Manyara.",
    "url": "https://www.lauparadiseadventure.com/safaris/ngorongoro-manyara-safari",
    "touristType": "Safari",
    "provider": {
        "@type": "TravelAgency",
...
<div class="page-hero" style="height:450px;">
    ...
    <div class="page-hero-content">
        <div class="breadcrumb">
            ...
            <span>/</span>
            <span class="current">Ngorongoro & Manyara Safari</span>
        </div>
        <h1 class="page-hero-title">Ngorongoro & <em>Manyara</em> Safari</h1>
        <p class="page-hero-sub">Two iconic parks in one incredible trip. Descend into Ngorongoro Crater and explore the flamingo-lined shores of Lake Manyara.</p>
    </div>
</div>

<section class="luxury-content">
    <div class="luxury-intro">
        <span class="sec-label">Popular Safari</span>
        <h2>Two Iconic Parks, <em>One</em> Incredible Trip</h2>
        <p>This 4-day safari pairs two of Tanzania's most spectacular destinations. Descend 600 metres into the Ngorongoro Crater, a UNESCO World Heritage Site teeming with lions, elephants, rhinos and flamingos. Then explore the groundwater forests and soda lake shores of Lake Manyara.</p>
        <p>Perfect for first-time visitors or those short on time, this itinerary packs maximum wildlife into a compact and affordable adventure through the Northern Safari Circuit.</p>
    </div>

    <div class="luxury-packages">
        <div class="luxury-card">
            <div class="luxury-card-img">
                <img src="https://res.cloudinary.com/dmqdm8gfk/image/upload/v1766046154/Angata-Tarangire-2-1-1536x863_amthnm.jpg" alt="Day 1 - Arusha to Lake Manyara" loading="lazy">
            </div>
            <div class="luxury-card-body">
                <div class="luxury-card-meta">
                    <span><i class="fas fa-calendar-day"></i> Day 1</span>
                </div>
                <h3 class="luxury-card-title">Arusha to Lake Manyara</h3>
                <p class="luxury-card-desc">Morning departure from Arusha. Afternoon game drive in Lake Manyara National Park, famous for its tree-climbing lions and flocks of flamingos.</p>
            </div>
        </div>
...
<section class="included-section">
    <div style="text-align:center;">
        ...
        <h2 class="sec-title" style="text-align:center;">What's Included in Your <em>Ngorongoro & Manyara</em> Safari</h2>
        <p class="sec-sub" style="text-align:center; margin:12px auto 0;">Everything you need for a seamless two-park adventure.</p>
    </div>
    <div class="included-grid">
        ...
        <div class="included-item">
            ...
            <div class="included-text">
                <h4>Accommodation</h4>
                <p>Mid-range lodges and tented camps with en-suite facilities near both parks.</p>
            </div>
        </div>
        <div class="included-item">
        ...
        <div class="included-item">
            ...
            <div class="included-text">
                ...
                <p>Expert English-speaking guide with extensive knowledge of both parks.</p>
            </div>
        </div>
        <div class="included-item">
            ...
            <div class="included-text">
                <h4>Transfers</h4>
                <p>Round-trip transfers from Arusha to both Ngorongoro and Lake Manyara.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="luxury-cta">
    <h2>Book My <em style="color:var(--gold-light);">Two-Park</em> Safari</h2>
    <p>Ready to explore two of Tanzania's most iconic parks? Contact our team to book your Ngorongoro and Manyara adventure.</p>
    <a href="/contact" class="btn-primary"><i class="fas fa-envelope"></i> Book My Two-Park Safari</a>
</section>
@endsection
