...
@section('page-title', 'Tarangire & Serengeti Safari | Classic Tanzania Safari')
@section('meta-description', "Two of Tanzania's crown jewels in one trip. Massive elephant herds in Tarangire, then the endless plains and Big Five of the Serengeti.")
@section('meta-keywords', 'Tarangire Serengeti safari, classic Tanzania safari, two park safari, elephant safari, Serengeti Big Five')
@section('canonical', 'https://www.lauparadiseadventure.com/safaris/tarangire-serengeti-safari')
...
<script type="application/ld+json">
{
    ...
    "@type": "TouristTrip",
    "name": "Tarangire & Serengeti Safari | Classic Tanzania Safari",
    "description": "Two of Tanzania's crown jewels in one trip. Massive elephant herds in Tarangire, then the endless plains and Big Five of the Serengeti.",
    "url": "https://www.lauparadiseadventure.com/safaris/tarangire-serengeti-safari",
    "touristType": "Safari",
    "provider": {
        "@type": "TravelAgency",
...
<div class="page-hero" style="height:450px;">
    ...
    <div class="page-hero-content">
        <div class="breadcrumb">
            ...
            <span>/</span>
            <span class="current">Tarangire & Serengeti Safari</span>
        </div>
        <h1 class="page-hero-title">Tarangire & <em>Serengeti</em> Safari</h1>
        <p class="page-hero-sub">Two of Tanzania's crown jewels in one trip. Massive elephant herds in Tarangire, then the endless plains and Big Five of the Serengeti.</p>
    </div>
</div>
...
<section class="luxury-content">
    <div class="luxury-intro">
        ...
        <h2>Tanzania's <em>Crown Jewels</em> in One Trip</h2>
        <p>This 6-day classic safari pairs two of Tanzania's most spectacular parks. Start with the elephant-rich landscapes of Tarangire National Park, home to the largest concentration of elephants in the country, then head to the Serengeti for the ultimate Big Five experience on the endless plains.</p>
        <p>From baobab-studded savanna to the vast grasslands where the Great Migration thunders across, this itinerary delivers the quintessential Tanzania safari experience.</p>
    </div>
...
<section class="included-section">
    <div style="text-align:center;">
        ...
        <h2 class="sec-title" style="text-align:center;">What's Included in Your <em>Classic Safari</em></h2>
        <p class="sec-sub" style="text-align:center; margin:12px auto 0;">Everything you need for a classic Tanzania adventure.</p>
    </div>
    <div class="included-grid">
        ...
        <div class="included-item">
            ...
            <div class="included-text">
                <h4>Transfers</h4>
                <p>Round-trip transfers from Arusha to Tarangire, Serengeti and Ngorongoro.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="luxury-cta">
    <h2>Book My <em style="color:var(--gold-light);">Classic</em> Safari</h2>
    <p>Ready for the quintessential Tanzania safari experience? Contact our team to book your Tarangire and Serengeti adventure.</p>
    <a href="/contact" class="btn-primary"><i class="fas fa-envelope"></i> Book My Classic Safari</a>
</section>
@endsection
